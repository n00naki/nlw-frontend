            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    <fieldset>
                        ...
                        <Input name="whatsapp" label="WhatsApp" value={whatsapp} onChange={(e) => { setWatsapp(e.target.value) }} />
                        <Textarea name="bio" label="Biogragia" value={bio} onChange={(e) => { setBio(e.target.value) }} />
                    </fieldset>
